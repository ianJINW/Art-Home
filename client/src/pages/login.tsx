      ...
      <fieldset className='w-full max-w-md border border-gray-300 rounded-lg p-6 bg-white dark:bg-gray-800 shadow-lg'>
        ...
        >
          ...
          <input
            ...
            type='email'
            className='border border-gray-400 rounded-md p-2 mt-1 w-full font-small dark:text-gray-200 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent'
            value={data.email}
